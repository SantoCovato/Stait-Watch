...
## 📸 Interface Showcase
Here is a look at the five main screens of the Stait Watch UI:

| Watchface | Notifications | Weather | Settings | Media Player |
| :---: | :---: | :---: | :---: | :---: |
| ![Watchface](images/main_screen_it.png) | ![Notifications](images/notifications_it.png) | ![Weather](images/weather_it.png) | ![Settings](images/settings_it.png) | ![Media](images/media_player_it.png) |
